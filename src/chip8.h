...
extern uint8_t drawflag;				// draw flag, saw this in another code, NB: yeah i used it, NB2: Actually i didn't
...
extern uint16_t keyboard[16];			// Keyboard (not implemented yet, not familiar yet with the SDL API, update: i'm currently implementing events)
